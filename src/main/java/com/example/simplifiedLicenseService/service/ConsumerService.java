...
public class ConsumerService {
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "license-topic2", partitions = {"0"})}, groupId =
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "license-topic2", partitions = {"1"})}, groupId =
            "license-consumer-group")
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = "license-topic2", partitions = {"2"})}, groupId =
            "license-consumer-group")
